    ...
    */
    ...
    public void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if(collision.gameObject.tag == "Line")
        {
            ...
            // baseSpeed += 0.1f;
            transform.rotation = Quaternion.RotateTowards(transform.rotation, collision.gameObject.transform.rotation * Quaternion.Euler(0, 0, 270), 10);
            /*
            ...
            */
            // SpeedEffect();
            // collision.gameObject.SetActive(false);
            // collision.sr.color = new Color(1f,1f,1,1f);
            // Instantiate(getWind,transform.position, Quaternion.identity);
